...
//        wp_enqueue_style( 'dn-tools-for-klaviyo-frontend-styles', PluginConfig::get_plugin_url() . 'assets/frontend/css/frontend-styles.css', [], PluginConfig::get_plugin_version(), 'all' );
	    wp_enqueue_script_module( 'dn-tools-for-klaviyo-frontend-script', PluginConfig::get_plugin_url() . 'assets/frontend/js/frontend.js', [], PluginConfig::get_plugin_version(), 'all' );
    }
}
